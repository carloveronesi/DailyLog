...
export function CalendarGrid({ year, month, gridDates, monthDataByDate, openEditor, clientColors = {} }) {
    ...
    return (
        <section className="flex flex-col lg:h-full rounded-3xl border border-slate-200/90 bg-white/80 backdrop-blur p-5 shadow-soft dark:shadow-soft-dark dark:border-slate-700/50 dark:bg-slate-800/80">
            ...
            <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 lg:auto-rows-fr gap-2.5 flex-1 min-h-0">
                {gridDates.map((d) => {
